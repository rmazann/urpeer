  ...
  public: {
    Tables: {
      ...
      changelog_feedback_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "changelog_feedback_links_changelog_id_fkey"
          ...
          {
            foreignKeyName: "changelog_feedback_links_feedback_id_fkey"
            columns: ["feedback_id"]
            isOneToOne: false
      ...
      roadmap_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "roadmap_items_feedback_id_fkey"
            columns: ["feedback_id"]
            isOneToOne: false
            referencedRelation: "feedback"
            referencedColumns: ["id"]
